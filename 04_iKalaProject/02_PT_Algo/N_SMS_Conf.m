...
PT_BSS = zeros(numMusics,6*10);
PT_Sine_BSS = zeros(numMusics,6*10);
...
for t = 1:numMusics
    ...
    for freqDevOffset = 5:5:50;        % The minimum frequency deviation at 0 Hz
        ...
        PT_BSS(t,(b*6)-5) = gather(NSDR(1));
        PT_BSS(t,(b*6)-4) = gather(NSDR(2));
        PT_BSS(t,(b*6)-3) = gather(SIR(1));
        PT_BSS(t,(b*6)-2) = gather(SIR(2));
        PT_BSS(t,(b*6)-1) = gather(SAR(1));
        PT_BSS(t,b*6) = gather(SAR(2));
        ...
        PT_Sine_BSS(t,(b*6)-5) = gather(NSDR(1));
        PT_Sine_BSS(t,(b*6)-4) = gather(NSDR(2));
        PT_Sine_BSS(t,(b*6)-3) = gather(SIR(1));
        PT_Sine_BSS(t,(b*6)-2) = gather(SIR(2));
        PT_Sine_BSS(t,(b*6)-1) = gather(SAR(1));
        PT_Sine_BSS(t,b*6) = gather(SAR(2));
