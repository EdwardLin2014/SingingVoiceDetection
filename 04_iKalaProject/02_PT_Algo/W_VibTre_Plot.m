...
tic
FMPartials = PT_Algo_FM_C( Mix.mXdB, Mix.ploc, Voice.IBMPeak, Parm );
Parm.freqDevOffset = 10;                    % Change for SMS
SMSPartials = PT_Algo_SMS_C( Mix.mXdB, Mix.ploc, Voice.IBMPeak, Parm );
MQPartials = PT_Algo_MQ_C( Mix.mXdB, Mix.ploc, Voice.IBMPeak, Parm );
...
h = legend(h, 'Singing Voice Partials','Music Accompaniment Partials','Location','northeast','Orientation','horizontal');
set(h,'FontWeight','bold','FontSize',LegendFontSize);
