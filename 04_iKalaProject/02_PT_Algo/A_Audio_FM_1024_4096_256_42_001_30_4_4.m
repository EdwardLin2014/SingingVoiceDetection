...
for t = 1:numMusics
    ...
    tic
    if t <= 137
        audiowrite([AudioOutDirStr, '/FM_iSTFT_1024_4096_256_42_001_30_4_4/',num2str(t),'_Voice_',WavFileDirs{t}(end-14:end)], Voice.IBMPeaky, fs );
        audiowrite([AudioOutDirStr, '/FM_iSTFT_1024_4096_256_42_001_30_4_4/',num2str(t),'_Song_',WavFileDirs{t}(end-14:end)], Song.IBMPeaky, fs );
        audiowrite([AudioOutDirStr, '/FM_AS_1024_4096_256_42_001_30_4_4/',num2str(t),'_Voice_',WavFileDirs{t}(end-14:end)], Voice.IBMPeakSiney, fs );
        audiowrite([AudioOutDirStr, '/FM_AS_1024_4096_256_42_001_30_4_4/',num2str(t),'_Song_',WavFileDirs{t}(end-14:end)], Song.IBMPeakSiney, fs );
    else
        audiowrite([AudioOutDirStr, '/FM_iSTFT_1024_4096_256_42_001_30_4_4/',num2str(t),'_Voice_',WavFileDirs{t}(end-15:end)], Voice.IBMPeaky, fs );
        audiowrite([AudioOutDirStr, '/FM_iSTFT_1024_4096_256_42_001_30_4_4/',num2str(t),'_Song_',WavFileDirs{t}(end-15:end)], Song.IBMPeaky, fs );
        audiowrite([AudioOutDirStr, '/FM_AS_1024_4096_256_42_001_30_4_4/',num2str(t),'_Voice_',WavFileDirs{t}(end-15:end)], Voice.IBMPeakSiney, fs );
        audiowrite([AudioOutDirStr, '/FM_AS_1024_4096_256_42_001_30_4_4/',num2str(t),'_Song_',WavFileDirs{t}(end-15:end)], Song.IBMPeakSiney, fs );
    end
