...
for t = 1:numMusics
    ...
    tic
    if t <= 137
        audiowrite([AudioOutDirStr, '/IBM_iSTFT_2048_2048_512/',num2str(t),'_Voice_',WavFileDirs{t}(end-14:end)], Voice.IBMy, fs );
        audiowrite([AudioOutDirStr, '/IBM_iSTFT_2048_2048_512/',num2str(t),'_Song_',WavFileDirs{t}(end-14:end)], Song.IBMy, fs );
        audiowrite([AudioOutDirStr, '/IBMPeak_iSTFT_2048_2048_512/',num2str(t),'_Voice_',WavFileDirs{t}(end-14:end)], Voice.IBMPeaky, fs );
        audiowrite([AudioOutDirStr, '/IBMPeak_iSTFT_2048_2048_512/',num2str(t),'_Song_',WavFileDirs{t}(end-14:end)], Song.IBMPeaky, fs );
        audiowrite([AudioOutDirStr, '/IBMPeak_AS_2048_2048_512/',num2str(t),'_Voice_',WavFileDirs{t}(end-14:end)], Voice.IBMPeakSiney, fs );
        audiowrite([AudioOutDirStr, '/IBMPeak_AS_2048_2048_512/',num2str(t),'_Song_',WavFileDirs{t}(end-14:end)], Song.IBMPeakSiney, fs );
    else
        audiowrite([AudioOutDirStr, '/IBM_iSTFT_2048_2048_512/',num2str(t),'_Voice_',WavFileDirs{t}(end-15:end)], Voice.IBMy, fs );
        audiowrite([AudioOutDirStr, '/IBM_iSTFT_2048_2048_512/',num2str(t),'_Song_',WavFileDirs{t}(end-15:end)], Song.IBMy, fs );
        audiowrite([AudioOutDirStr, '/IBMPeak_iSTFT_2048_2048_512/',num2str(t),'_Voice_',WavFileDirs{t}(end-15:end)], Voice.IBMPeaky, fs );
        audiowrite([AudioOutDirStr, '/IBMPeak_iSTFT_2048_2048_512/',num2str(t),'_Song_',WavFileDirs{t}(end-15:end)], Song.IBMPeaky, fs );    
        audiowrite([AudioOutDirStr, '/IBMPeak_AS_2048_2048_512/',num2str(t),'_Voice_',WavFileDirs{t}(end-15:end)], Voice.IBMPeakSiney, fs );
        audiowrite([AudioOutDirStr, '/IBMPeak_AS_2048_2048_512/',num2str(t),'_Song_',WavFileDirs{t}(end-15:end)], Song.IBMPeakSiney, fs );
    end
